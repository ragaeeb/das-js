    ...
    <>
      ...
      <section id="hero" className="jumbotron">
        <Container>
          ...
          <p>
            Your privacy is important to us. It is the policy of Dar as-Sahaba to respect your
            privacy regarding any information we may collect from you across our website,{' '}
            <a href="https://dar-as-sahaba.com">https://dar-as-sahaba.com</a>, and other sites we
            own and operate.
          </p>
          <p>
          ...
          <p>This policy is effective as of 18 July 2020.</p>
        </Container>
      </section>
    </>
  );
