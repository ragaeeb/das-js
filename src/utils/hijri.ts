...
const kuwaiticalendar = (adjust: number, now: Date): KuwaitiCalendarResult => {
  let today = now;
...
const writeIslamicDate = (adjustment: number, today: Date): HijriDate => {
  const wdNames = [
    'al-ʾAḥad',
    'al-ʾIthnayn',
    'ath-Thulāthāʾ',
